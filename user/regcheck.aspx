<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="regcheck.aspx.cs" Inherits="user_regcheck" %>
			...
			<div class="row">
				<div class="col-xs-4 col-sm-3 col-md-3">
					<span class="button-checkbox">
						<button id="Button1" type="button" class="btn" data-color="info" runat="server" tabindex="7">I Agree</button>
