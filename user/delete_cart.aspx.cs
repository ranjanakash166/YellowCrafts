    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.Cookies["aa"] != null)
        {
            ...
            for (int i = 0; i < strarr.Length; i++)
            {
                ...
                dt.Rows.Add(a[0], a[1].ToString(), a[2].ToString(), a[3].ToString(), a[4].ToString(),i.ToString(),a[5].ToString());
            }
        ...
        foreach (DataRow dr in dt.Rows)
        {
            ...
            if (count == 1)
            {
                ...
                product_desc.ToString() + "," + product_price.ToString() + "," +
                product_qty.ToString() + "," + product_img.ToString()+","+product_id.ToString();
            ...
            {
                Response.Cookies["aa"].Value = Response.Cookies["aa"].Value + "|" + product_name.ToString() + "," +
                product_desc.ToString() + "," + product_price.ToString() + "," +
                product_qty.ToString() + "," + product_img.ToString() + "," + product_id.ToString(); 
                Response.Cookies["aa"].Expires = DateTime.Now.AddDays(1);
